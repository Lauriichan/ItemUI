...
public final class JavaAccessor {
    ...
    public static Method getDeclaredMethod(final Class<?> clazz, final Class<?> returnType, List<String> blacklisted,
    ...
    public static Method getStaticMethod(final Class<?> clazz, final Class<?> returnType, List<String> blacklisted,
        final Class<?>... arguments) {
        return getMethod(clazz, true, returnType, blacklisted, arguments);
    }

    public static Method getMethod(final Class<?> clazz, final boolean isStatic, final Class<?> returnType, List<String> blacklisted,
        final Class<?>... arguments) {
        if (clazz == null) {
            return null;
        }
